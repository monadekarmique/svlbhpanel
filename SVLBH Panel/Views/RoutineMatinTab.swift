    ...
    private var tableauCertifiees: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 0) {
                ...
                Text("Capacité maximale").font(.caption2.bold()).foregroundColor(.secondary).frame(width: 80, alignment: .trailing)
                Text("Liens actifs").font(.caption2.bold()).foregroundColor(.secondary).frame(width: 80, alignment: .trailing)
